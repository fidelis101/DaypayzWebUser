                    ...
                    <div class="col-xs-6 col-xs-offset-3 col-sm-6 col-sm-offset-3">
                        <div class="card">
			             ...
			             <form method="post" action="process_payment.php">
                            ...
                            <p class="text-primary">Please note that funding your wallet through card attracts a card processing fee of 1.5%. To avoid paying this charge, please load your wallet through bank deposit.</p>
