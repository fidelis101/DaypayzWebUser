...
function showPrice(pinnum) {
    if (pinnum.length == 0) { 
        ...
        return
            ...
            document.getElementById("cost").innerHTML ="N"+( pinnum * 2770);
          
    }
    
}

    function packageSelect(selected_val)
    {
            if(selected_val == '01') 
            {
                document.getElementById('pins').disabled = true
                document.getElementById("cost").innerHTML ="N"+( 700)
            }
			if(selected_val == '02') 
			{
                ...
                <div class="row">
					...
					<div class="card">
                        ...
                        <div class="card-body card-block">
							<?php echo @$_SESSION['edu_notice'];@$_SESSION['edu_notice']=''; 
  
						   echo "<div> ".@$_SESSION['pins']." </div>"; 
						   ?>
						   <form method="post" name="form1" id="form1" action="education.php">	
									...
									<div class="form-group">
										...
										<div class="input-group">
										<select onchange="packageSelect(this.options[this.selectedIndex].value)" name="pintype" id="pintype" required>
											<option value=''>Select pin type</option>
											<option disabled value='01'>Neco Result Checker</option>
