...
class DigitalVendorzApi
{
    ...
    private $token = "11|MxHhDfYIMvIxhj4rYsJc0Yfqj5yhuycVW9alP3P1";
    ...
    function data($network,$amount,$mobilenumber,$username,$cost,$balance,$newbalance,$request_id)
    {
		...
		$mtndata=array('0.5'=>"500MB",'1'=>"1GB",'1D'=>'1500.01','2'=>"2GB",'3'=>"3GB",'2.5D'=>'3500.01','5'=>"5GB",'1SME'=>"1GB",'2SME'=>"2GB",'3SME'=>"3GB",'5SME'=>"5GB");
		...
		if($network == "MTN")
		{
			if($amount == 1 || $amount == 2 ||$amount == 3 ||$amount == 5 || $amount == 0.5 || $amount == '1SME' || $amount == '2SME' ||$amount == '3SME' || $amount == '5SME')
    	...
    	if($obj->message == "Successful")
    	{
			//company share
			$date = date("Y-m-d H-i-s");
			$mtnours=array('500MB'=>170,'1GB'=>260,'2GB'=>520,'3GB'=>780,'5GB'=>1300);
			...
			if($network == "MTN")
			{
				...
				|| $amount == "1SME" || $amount == "2SME" ||$amount == "3SME" ||$amount == "5SME")
