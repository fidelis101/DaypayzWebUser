...
$j = 6;
   while($t <= 6)
   {
    ...
    <div class='container'>
    <img src='images/complete.JPG' alt='gene' width='100%' />
    <div class='username' >".$md[$t]."</div>
    		<div class='d1' >".$dd[1]."</div>
    		<div class='d2' >".$dd[2]."</div>
    		<div class='d3' >".$dd[3]."</div>
    		<div class='d4' >".$dd[4]."</div>
    		<div class='d5' >".$dd[5]."</div>
    		<div class='d6' >".$dd[6]."</div>
