...
<option value="18000">119GB 30Days incl 10GB nite = ₦18000</option>`;
    ...
    <option value="15000">75GB (30 Days) = ₦15000</option>`;    
        ...
        document.getElementById("amount").innerHTML = `<option selected>Select amount</option>
                                                        <option value='0.5SME'>500MB SME (N185)</option>
                                                        <option value='1SME'>1GB SME (N295)</option>
                                                        
                                                        <option value='2SME'>2GB SME (N590)</option>
                                                        
                                                        <option value='3SME'>3GB SME (N885)</option>
                                                        
                                                        <option value='5SME'>5GB SME (N1,475)</option>
                                                        <option value='10SME'>10GB SME (N2,950)</option>`;
    }
