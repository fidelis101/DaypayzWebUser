...
<option value="18000">119GB 30Days incl 10GB nite = ₦18000</option>`;
    ...
    <option value="15000">75GB (30 Days) = ₦15000</option>`;    
        ...
        document.getElementById("amount").innerHTML = `<option selected>Select amount</option>
                                                        ...
                                                        <option value='1SME'>1GB SME (N315)</option>
                                                        
                                                        <option value='2SME'>2GB SME (N630)</option>
                                                        
                                                        <option value='3SME'>3GB SME (N945)</option>
                                                        
                                                        <option value='5SME'>5GB SME (N1,575)</option>
                                                        <option value='10SME'>10GB SME (N5,150)</option>`;
    }
