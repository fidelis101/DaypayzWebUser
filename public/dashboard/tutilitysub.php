                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
							...
							<form method="post" onsubmit="btk()" name="form1" id="form1" action="tsubscribe_electricity.php">
                                ...
                                <div class="form-group">
									...
									<select class="standardSelect" id="provider" name="provider" required>
										...
										<option style="display:none" value="04">Kano Electricity</option>
										<option value="05">Portharcourt Electricity</option>
										<option style="display:none" value="06">Jos Electricity</option>
